...
from view_4 import render_index_html  # Dinamik HTML oluşturmak için
from modal_4 import BASE_ROOT, get_current_path_from_url, is_safe_path, rename_file_or_folder, delete_file_or_folder  # URL işlemleri için


PORT = 8083  # Sunucunun dinleyeceği port numarası
