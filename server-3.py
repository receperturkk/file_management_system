...
from view_3 import render_index_html  # Dinamik HTML oluşturmak için
from modal_3 import BASE_ROOT, get_current_path_from_url, is_safe_path, rename_file_or_folder, delete_file_or_folder  # URL işlemleri için


PORT = 8082  # Sunucunun dinleyeceği port numarası
